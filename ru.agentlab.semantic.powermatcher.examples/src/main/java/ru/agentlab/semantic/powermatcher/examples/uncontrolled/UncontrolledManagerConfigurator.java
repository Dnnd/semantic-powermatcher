...
@Designate(ocd = UncontrolledManagerConfigurator.Config.class, factory = true)
public class UncontrolledManagerConfigurator implements ThingServiceConfigurator {
        ...
        try (var res = conn.prepareTupleQuery(query.getQueryString()).evaluate()) {
            for (BindingSet bindings : res) {
                ...
                switch (property) {
                    ...
                    case "expirationTime" -> serviceConfiguration.put(property, Literals.getIntValue(value, -1));
    ...
    public String getConfigurationPID() {
        return "org.flexiblepower.uncontrolled.manager.UncontrolledManager";
    }

    @Override
    public String getBundleID() {
        return "flexiblepower.manager.uncontrolled";
    }
